...
| [`constraints.md`](constraints.md) | ✓ | Living register of standing model/platform limits — "why the agent behaves the way it does," cross-linked to ADRs. |
...
| [`tooling.md`](tooling.md) | ✓ | How to pull full Vapi context from the terminal (official CLI: `vapi call get` / `assistant get`), and its gotchas. |
