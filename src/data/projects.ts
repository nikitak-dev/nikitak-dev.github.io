...
export const PROJECTS: readonly Project[] = [
  ...
  },
  {
    ...
    category: 'automation',
    url: '/db-merge/',
    desc: 'What if databases that store the same records in completely different shapes could merge themselves? This pipeline pulls from multiple systems with clashing schemas, reconciles them into one clean table, deduplicates, and syncs every destination on a schedule. Built as a fault-tolerant ETL flow.',
    stack: 'n8n | Google Sheets | Airtable | Discord',
    meta: 'For teams stitching reports together by hand every week',
  ...
  },
  {
    ...
    meta: 'For anyone manually recreating folder structures in Google Drive',
